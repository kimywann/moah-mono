...
const BASE_BUTTON =
  "inline-flex semibold items-center justify-center whitespace-nowrap medium rounded-tiny leading-body transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2 cursor-pointer";
